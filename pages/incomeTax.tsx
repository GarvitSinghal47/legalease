...
export default function IncomeTax() {
  ...
  useEffect(() => {
    console.log("Pinecone Environment", process.env.NEXT_PUBLIC_PINECONE_ENVIRONMENT );
    console.log("Pinecone API Key", process.env.NEXT_PUBLIC_PINECONE_API_KEY);
